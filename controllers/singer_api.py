...
@singer_router.get('/singers', 
response_model = List[SingerInDB], 
status_code=status.HTTP_200_OK, 
name="singers:get-all")
...
@singer_router.get('/singers/{id}',
response_model= SingerWithAlbums,
status_code=status.HTTP_200_OK,
name="singers:get-albums-singer")
...
@singer_router.get('/singer/{id}', 
response_model= SingerWithSongs, 
status_code=status.HTTP_200_OK, 
name="singers:get-songs-singer")
